...
figure(4)
clf
semilogy([1:1e4:Niter], saveaccuracy(1:1e4:Niter),'b-','LineWidth',2)
xlabel('Iteration Number')
ylabel('Accuracy')
set(gca,'FontWeight','Bold','FontSize',18)
  ...
  function [costval, accuracy] = cost(W2,W3,W4,b2,b3,b4)
     ...
     accuracy = accuracy/length(x1); % divides accuracy by total number of points to get percentage of accurate points
